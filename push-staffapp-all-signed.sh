...
# Pushes: staff-app-staging-release.apk staff-app-release.apk
# Usage: ./push-staffapp-all-signed.sh <commit message>   (message may be unquoted / multi-word)
...
FILES=(staff-app-staging-release.apk staff-app-release.apk)
